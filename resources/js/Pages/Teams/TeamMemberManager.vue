    ...
    <div>
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <jet-form-section @submitted="addTeamMember">
                ...
                <template #description>
                    Adicionar um novo membro na sua equipe, permitindo que ele
                    colabore com você.
                </template>
                ...
                <template #form>
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            Por favor informe o e-mail da pessoa que você deseja
                            adicionar a esta equipe. Esse e-mail deve estar
                            associado a uma conta existente.
                        </div>
                    </div>
                    ...
                    >
                        <jet-label for="roles" value="Papel" />
                        <jet-input-error
        ...
        <div v-if="team.users.length > 0">
            ...
            <jet-action-section class="mt-10 sm:mt-0">
                ...
                <template #description>
                    Todas pessoas que fazem parte dessa equipe.
                </template>
